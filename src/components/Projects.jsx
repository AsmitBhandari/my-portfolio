...
const Projects = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            src: '/e-kart.png',
            github: 'https://github.com/AsmitBhandari/E-Kart',
        },
        {
            id: 3,
            ...
            github: 'https://github.com/AsmitBhandari/BrailleBridge',
        },
        {
            id: 4,
            title: 'Code-Morpher',
            description: 'Code Morpher is a code transpiler platform that converts code between various programming languages and also shows tokenized, parsed and AST representation of the code.',
            tech: ['react', 'Java', 'ANTLR4', 'FAST API', 'TAILWIND CSS'],
            src: '/code-morpher.jpeg',
            github: 'https://github.com/AsmitBhandari/Code-Morpher',
        },
        {
            id: 5,
            ...
            github: 'https://github.com/AsmitBhandari/Flight-Seat-Allocator',
        },
        {
            id: 6,
            ...
            src: '/dmfs.png',
            github: 'https://github.com/AsmitBhandari/Distributed-Mini-File-System',
        },
    ];
