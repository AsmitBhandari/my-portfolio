        ...
        <div id="home" className="min-h-screen md:h-screen w-full bg-transparent text-white relative overflow-hidden pt-20 md:pt-0">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between min-h-screen md:h-full px-4 py-10 md:py-0">
                ...
                <div className="flex flex-col justify-center w-full md:w-1/2 z-10">
                    ...
                    >
                        Designing and developing <span className="text-accent font-semibold">innovative digital experiences</span> that integrate modern web engineering, machine learning, and AI-driven solutions.
                    </motion.p>
                    ...
                    <div className="flex mt-8 gap-6 z-20 items-center">
                        ...
                        <motion.a
                            whileHover={{ scale: 1.2, rotate: 5 }}
                            href="https://www.instagram.com/asmit_bhandari1/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-3xl hover:text-accent transition duration-300"
                        >
